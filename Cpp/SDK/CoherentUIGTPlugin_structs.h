...
struct FCoherentUIGTLoadingScreenSettings
{
	...
	unsigned char                                      UnknownData_9KHL[0x2];                                     // 0x0006(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FCoherentUIGTViewInfo
{
	...
	unsigned char                                      UnknownData_21XL[0x3];                                     // 0x0009(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
