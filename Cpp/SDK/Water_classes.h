...
{
public:
	unsigned char                                      UnknownData_9H5O[0x28];                                    // 0x0470(0x0028) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_Y6OC[0x8];                                     // 0x0430(0x0008) MISSED OFFSET (PADDING)
...
public:
	...
	TEnumAsByte<Water_EWaterQueryResult> GetWaterHeightsBatched(TArray<struct FVector2D> SamplePositions, class AActor* Actor, TArray<float>* Heights);
...
{
public:
	unsigned char                                      UnknownData_Q9CX[0x10];                                    // 0x0428(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_NFF3[0x50];                                    // 0x0450(0x0050) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
public:
	unsigned char                                      UnknownData_YL8E[0x8];                                     // 0x0538(0x0008) Fix Super Size
	unsigned char                                      UnknownData_6Y7S[0x10];                                    // 0x0540(0x0010) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_B594[0x10];                                    // 0x0028(0x0010) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_0OR1[0x28];                                    // 0x00C8(0x0028) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
public:
	unsigned char                                      UnknownData_2Z93[0x20];                                    // 0x0028(0x0020) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_TIPB[0x20];                                    // 0x0560(0x0020) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_Q862[0x4];                                     // 0x00E4(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_J43L[0x4];                                     // 0x0104(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	TArray<struct FWaterSpout>                         ActiveWaterSpouts;                                         // 0x0108(0x0010) (ZeroConstructor, ContainsInstancedReference)
	unsigned char                                      UnknownData_PM07[0x18];                                    // 0x0118(0x0018) MISSED OFFSET (PADDING)
