...
public:
	...
	unsigned char                                      UnknownData_WH1X[0x28];                                    // 0x0088(0x0028) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_OIUQ[0x24];                                    // 0x00D4(0x0024) MISSED OFFSET (PADDING)
