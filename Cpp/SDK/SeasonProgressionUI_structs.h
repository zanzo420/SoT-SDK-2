...
struct FSeasonGoalPopupAsset
{
	...
	unsigned char                                      UnknownData_Z0X4[0x4];                                     // 0x007C(0x0004) MISSED OFFSET (PADDING)
...
struct FSeasonNotificationContent
{
	...
	unsigned char                                      UnknownData_F3YT[0x4];                                     // 0x0064(0x0004) MISSED OFFSET (PADDING)
...
struct FNavigationDesc
{
	...
	unsigned char                                      UnknownData_IBW5[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FDeedProgressDesc
{
	...
	unsigned char                                      UnknownData_KEFZ[0x4];                                     // 0x003C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FSeasonIconPopupAsset
{
	...
	unsigned char                                      UnknownData_K73J[0x4];                                     // 0x0064(0x0004) MISSED OFFSET (PADDING)
...
struct FEnableMoreButtonEvent
{
	...
	unsigned char                                      UnknownData_M3MA[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FOpenSeasonsMenuEvent
{
	...
	unsigned char                                      UnknownData_BAW1[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FGuid                                       Id;                                                        // 0x0004(0x0010) (ZeroConstructor, IsPlainOldData, NoDestructor)
...
struct FSeasonsPopupEvent
{
	...
	unsigned char                                      UnknownData_3GJE[0x4];                                     // 0x009C(0x0004) MISSED OFFSET (PADDING)
