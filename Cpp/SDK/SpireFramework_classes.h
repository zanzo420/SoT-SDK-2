...
public:
	...
	unsigned char                                      UnknownData_0FVM[0x8];                                     // 0x0070(0x0008) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_59H0[0x8];                                     // 0x0070(0x0008) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_4Q2H[0x50];                                    // 0x0100(0x0050) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_JR5C[0x8];                                     // 0x0428(0x0008) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_VQD2[0x8];                                     // 0x0428(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	TArray<struct FSpireInfo>                          SpireLevels;                                               // 0x0430(0x0010) (Net, ZeroConstructor, RepNotify)
	unsigned char                                      UnknownData_SGUC[0x48];                                    // 0x0440(0x0048) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_09GC[0x20];                                    // 0x0040(0x0020) MISSED OFFSET (PADDING)
