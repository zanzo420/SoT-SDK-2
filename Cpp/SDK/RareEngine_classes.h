...
{
public:
	unsigned char                                      UnknownData_H2MJ[0x58];                                    // 0x0AA8(0x0058) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_MD2U[0x1F0];                                   // 0x0028(0x01F0) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_F47H[0x8];                                     // 0x0028(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FScriptMulticastDelegate                    Callback;                                                  // 0x0030(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	unsigned char                                      UnknownData_LPIE[0x10];                                    // 0x0040(0x0010) MISSED OFFSET (PADDING)
