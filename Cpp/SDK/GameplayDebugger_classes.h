...
// 0x0230 (FullSize[0x0758] - InheritedSize[0x0528])
class UGameplayDebuggingComponent : public UPrimitiveComponent
{
public:
	unsigned char                                      UnknownData_WUDI[0x8];                                     // 0x0528(0x0008) Fix Super Size
	struct FString                                     DebugComponentClassName;                                   // 0x0530(0x0010) (ZeroConstructor, Config, GlobalConfig, HasGetValueTypeHash)
	int                                                ShowExtendedInformatiomCounter;                            // 0x0540(0x0004) (Net, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	unsigned char                                      UnknownData_OT7S[0x4];                                     // 0x0544(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	TArray<int>                                        ReplicateViewDataCounters;                                 // 0x0548(0x0010) (Net, ZeroConstructor)
	struct FString                                     ControllerName;                                            // 0x0558(0x0010) (Net, ZeroConstructor, HasGetValueTypeHash)
	struct FString                                     PawnName;                                                  // 0x0568(0x0010) (Net, ZeroConstructor, HasGetValueTypeHash)
	struct FString                                     PawnClass;                                                 // 0x0578(0x0010) (Net, ZeroConstructor, HasGetValueTypeHash)
	struct FString                                     DebugIcon;                                                 // 0x0588(0x0010) (Net, ZeroConstructor, HasGetValueTypeHash)
	struct FString                                     MovementBaseInfo;                                          // 0x0598(0x0010) (Net, ZeroConstructor, HasGetValueTypeHash)
	struct FString                                     MovementModeInfo;                                          // 0x05A8(0x0010) (Net, ZeroConstructor, HasGetValueTypeHash)
	struct FString                                     PathFollowingInfo;                                         // 0x05B8(0x0010) (Net, ZeroConstructor, HasGetValueTypeHash)
	struct FString                                     CurrentAITask;                                             // 0x05C8(0x0010) (Net, ZeroConstructor, HasGetValueTypeHash)
	struct FString                                     CurrentAIState;                                            // 0x05D8(0x0010) (Net, ZeroConstructor, HasGetValueTypeHash)
	struct FString                                     CurrentAIAssets;                                           // 0x05E8(0x0010) (Net, ZeroConstructor, HasGetValueTypeHash)
	struct FString                                     GameplayTasksState;                                        // 0x05F8(0x0010) (Net, ZeroConstructor, HasGetValueTypeHash)
	struct FString                                     NavDataInfo;                                               // 0x0608(0x0010) (Net, ZeroConstructor, HasGetValueTypeHash)
	struct FString                                     AbilityInfo;                                               // 0x0618(0x0010) (Net, ZeroConstructor, HasGetValueTypeHash)
	struct FString                                     MontageInfo;                                               // 0x0628(0x0010) (Net, ZeroConstructor, HasGetValueTypeHash)
	struct FString                                     BrainComponentName;                                        // 0x0638(0x0010) (Net, ZeroConstructor, HasGetValueTypeHash)
	struct FString                                     BrainComponentString;                                      // 0x0648(0x0010) (Net, ZeroConstructor, HasGetValueTypeHash)
	TArray<unsigned char>                              BlackboardRepData;                                         // 0x0658(0x0010) (Net, ZeroConstructor, RepNotify)
	unsigned char                                      UnknownData_HCY3[0x10];                                    // 0x0668(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	TArray<struct FVector>                             PathPoints;                                                // 0x0678(0x0010) (Net, ZeroConstructor)
	TArray<unsigned char>                              PathCorridorData;                                          // 0x0688(0x0010) (Net, ZeroConstructor, RepNotify)
	unsigned char                                      UnknownData_LDZO[0x10];                                    // 0x0698(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	TArray<unsigned char>                              NavmeshRepData;                                            // 0x06A8(0x0010) (Net, ZeroConstructor, RepNotify)
	TArray<unsigned char>                              EQSRepData;                                                // 0x06B8(0x0010) (Net, ZeroConstructor, RepNotify)
	struct FVector                                     SensingComponentLocation;                                  // 0x06C8(0x000C) (Net, ZeroConstructor, IsPlainOldData, NoDestructor)
	int                                                NextPathPointIndex;                                        // 0x06D4(0x0004) (Net, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	unsigned char                                      bIsUsingPathFollowing : 1;                                 // 0x06D8(0x0001) BIT_FIELD (Net, NoDestructor)
	unsigned char                                      bIsUsingCharacter : 1;                                     // 0x06D8(0x0001) BIT_FIELD (Net, NoDestructor)
	unsigned char                                      bIsUsingBehaviorTree : 1;                                  // 0x06D8(0x0001) BIT_FIELD (Net, NoDestructor)
	unsigned char                                      bIsUsingAbilities : 1;                                     // 0x06D8(0x0001) BIT_FIELD (Net, NoDestructor)
	unsigned char                                      UnknownData_299R[0x7];                                     // 0x06D9(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	class AActor*                                      TargetActor;                                               // 0x06E0(0x0008) (Net, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	unsigned char                                      UnknownData_XLH5[0x70];                                    // 0x06E8(0x0070) Fix Super Size
...
public:
	...
	unsigned char                                      UnknownData_Z45X[0xD0];                                    // 0x0448(0x00D0) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_QTG2[0x3];                                     // 0x007D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_IQXE[0x4E];                                    // 0x008A(0x004E) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_I16N[0x28];                                    // 0x00E8(0x0028) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
public:
	unsigned char                                      UnknownData_I3J0[0x30];                                    // 0x0520(0x0030) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_40L1[0x4];                                     // 0x045C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_0H2D[0x1];                                     // 0x047F(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_2I8U[0x7E];                                    // 0x048A(0x007E) MISSED OFFSET (PADDING)
