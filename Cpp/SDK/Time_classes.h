...
{
public:
	unsigned char                                      UnknownData_PMKL[0x38];                                    // 0x0428(0x0038) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FTimespan                                   GameWorldTimeOffset;                                       // 0x0460(0x0008) (Edit, Net, ZeroConstructor, Config, DisableEditOnInstance, Protected)
	unsigned char                                      UnknownData_LJ7F[0x8];                                     // 0x0468(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_H1MI[0x7C];                                    // 0x04BC(0x007C) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_WCKW[0x8];                                     // 0x0538(0x0008) MISSED OFFSET (PADDING)
...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("Class Time.TestTimeService");
		return ptr;
	}
