...
struct FBuoyancySampleMovementConfigurationEntry
{
	...
	unsigned char                                      UnknownData_36QP[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FBuoyancySampleMovementConfiguration
{
	...
	unsigned char                                      UnknownData_P3C2[0x4];                                     // 0x001C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_Y6BI[0x4];                                     // 0x0034(0x0004) MISSED OFFSET (PADDING)
...
struct FBuoyancySampleMovement
{
	...
	unsigned char                                      UnknownData_UJOM[0x40];                                    // 0x0010(0x0040) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_AED3[0x8];                                     // 0x0060(0x0008) MISSED OFFSET (PADDING)
...
struct FWaterSpout
{
	...
	unsigned char                                      UnknownData_ESHP[0x30];                                    // 0x0040(0x0030) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_G11V[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_QJCR[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
struct FFFTWaterQueryResult
{
	...
	unsigned char                                      UnknownData_264Z[0x3];                                     // 0x0019(0x0003) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_JN7A[0x20];                                    // 0x0048(0x0020) MISSED OFFSET (PADDING)
...
struct FWaterInformation
{
	...
	unsigned char                                      UnknownData_GQTY[0x7];                                     // 0x0009(0x0007) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_FWR1[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_XQVH[0x2];                                     // 0x004A(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	float                                              StaticWaterHeightValue;                                    // 0x004C(0x0004) (Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	unsigned char                                      UnknownData_AA61[0x88];                                    // 0x0050(0x0088) MISSED OFFSET (PADDING)
...
struct FWaterSplashProbesContainer
{
	...
	unsigned char                                      UnknownData_LZJJ[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (PADDING)
...
struct FSplashProbe
{
	unsigned char                                      UnknownData_OGGR[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_ZACQ[0x1];                                     // 0x00F3(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_CG4E[0x7];                                     // 0x0101(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_1XZU[0x18];                                    // 0x0110(0x0018) MISSED OFFSET (PADDING)
...
struct FBuoyancyVolumeSample
{
	...
	unsigned char                                      UnknownData_06J4[0x2];                                     // 0x0012(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_QT0N[0x4];                                     // 0x001C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_M0V2[0x10];                                    // 0x0048(0x0010) MISSED OFFSET (PADDING)
...
struct FBuoyancyDragSample
{
	...
	unsigned char                                      UnknownData_Q4XP[0x63];                                    // 0x002D(0x0063) MISSED OFFSET (PADDING)
...
struct FWaterBuoyancy
{
	...
	unsigned char                                      UnknownData_H30A[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_0HCD[0xEC];                                    // 0x0044(0x00EC) MISSED OFFSET (PADDING)
