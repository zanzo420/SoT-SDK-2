...
{
public:
	unsigned char                                      UnknownData_TIE0[0x10];                                    // 0x0078(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	class AActor*                                      HealAreaOfEffectActor;                                     // 0x0088(0x0008) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	unsigned char                                      UnknownData_FIFH[0x10];                                    // 0x0090(0x0010) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_VLRA[0x8];                                     // 0x00C8(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	bool                                               IsShieldActive;                                            // 0x00D0(0x0001) (Net, ZeroConstructor, IsPlainOldData, RepNotify, NoDestructor)
	unsigned char                                      UnknownData_WSXN[0x57];                                    // 0x00D1(0x0057) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_UCTZ[0x8];                                     // 0x0078(0x0008) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_4E6M[0x38];                                    // 0x00C8(0x0038) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_BL2E[0x4];                                     // 0x0034(0x0004) MISSED OFFSET (PADDING)
