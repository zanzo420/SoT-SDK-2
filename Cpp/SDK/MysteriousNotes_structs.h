...
struct FPlayerMysteriousNoteItem
{
	...
	unsigned char                                      UnknownData_KNTL[0x8];                                     // 0x0040(0x0008) MISSED OFFSET (PADDING)
...
struct FMysteriousNoteInfo
{
	...
	unsigned char                                      UnknownData_JVVL[0x2];                                     // 0x0012(0x0002) MISSED OFFSET (PADDING)
...
struct FClientNoteData
{
	...
	unsigned char                                      UnknownData_FKAI[0x7];                                     // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FWieldableMysteriousNoteLayoutItem
{
	...
	unsigned char                                      UnknownData_R6HP[0x4];                                     // 0x009C(0x0004) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_EJFL[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_G3H8[0x10];                                    // 0x0000(0x0010) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_GMH9[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_RHXR[0x10];                                    // 0x0000(0x0010) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_NUML[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
struct FEventTriggerMysteriousNotesPopup
{
	...
	unsigned char                                      UnknownData_LMPB[0x7];                                     // 0x0009(0x0007) MISSED OFFSET (PADDING)
