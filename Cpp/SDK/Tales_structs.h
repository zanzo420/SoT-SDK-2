...
{
	unsigned char                                      UnknownData_18JP[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
struct FTaleQuestCargoRunContractItem
{
	...
	unsigned char                                      UnknownData_LBGX[0x10];                                    // 0x0008(0x0010) MISSED OFFSET (PADDING)
...
struct FCriticalActorDelegateData
{
	...
	unsigned char                                      UnknownData_K8CC[0x20];                                    // 0x0008(0x0020) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      UnknownData_F10P[0x8];                                     // 0x0040(0x0008) MISSED OFFSET (PADDING)
...
{
	class AActor*                                      CriticalActor;                                             // 0x0000(0x0008) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	unsigned char                                      UnknownData_GU0Y[0x38];                                    // 0x0008(0x0038) MISSED OFFSET (PADDING)
...
struct FPhasedItem
{
	...
	unsigned char                                      UnknownData_3KHU[0x17];                                    // 0x0011(0x0017) MISSED OFFSET (PADDING)
...
struct FPhasedActor
{
	...
	unsigned char                                      UnknownData_NOQS[0x8];                                     // 0x0010(0x0008) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_UCZY[0x20];                                    // 0x0000(0x0020) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_KCXE[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
struct FStepMerchantItemDesc
{
	...
	unsigned char                                      UnknownData_596C[0x20];                                    // 0x0000(0x0020) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
struct FTaleQuestDesc : public FQuestDesc
{
	...
	unsigned char                                      UnknownData_XEYJ[0x20];                                    // 0x0038(0x0020) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	...
	unsigned char                                      UnknownData_0BTV[0x6];                                     // 0x007A(0x0006) MISSED OFFSET (PADDING)
...
{
	struct FText                                       Name;                                                      // 0x0000(0x0018) ELEMENT_SIZE_MISMATCH (Edit, BlueprintVisible)
	unsigned char                                      UnknownData_2SG4[0x20];                                    // 0x0000(0x0020) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
{
	struct FText                                       Name;                                                      // 0x0000(0x0018) ELEMENT_SIZE_MISMATCH (Edit, BlueprintVisible)
	unsigned char                                      UnknownData_RV9G[0x20];                                    // 0x0000(0x0020) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	class UTexture*                                    Icon;                                                      // 0x0038(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
struct FTaleQuestDeliveryRequest
{
	...
	unsigned char                                      UnknownData_T1M7[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
