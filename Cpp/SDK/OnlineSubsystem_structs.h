...
struct FInAppPurchaseProductRequest
{
	...
	unsigned char                                      UnknownData_R8JV[0x7];                                     // 0x0011(0x0007) MISSED OFFSET (PADDING)
...
struct FOnlineStoreCatalogItem
{
	...
	unsigned char                                      UnknownData_J1LW[0x7];                                     // 0x0051(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FAchievementUpdatedEvent
{
	...
	unsigned char                                      UnknownData_LDYH[0x3];                                     // 0x0015(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
