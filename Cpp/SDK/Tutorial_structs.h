...
{
	unsigned char                                      UnknownData_78X4[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
struct FContextualTutorialPromptDesc
{
	...
	unsigned char                                      UnknownData_9059[0x4];                                     // 0x001C(0x0004) MISSED OFFSET (PADDING)
...
struct FTutorialStepEndedTelemetryEvent
{
	...
	unsigned char                                      UnknownData_CVTC[0x6];                                     // 0x0022(0x0006) MISSED OFFSET (PADDING)
