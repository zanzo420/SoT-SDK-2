...
struct FPrioritisedPrompt
{
	...
	unsigned char                                      UnknownData_V9Z5[0x20];                                    // 0x0000(0x0020) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	...
	unsigned char                                      UnknownData_YSNN[0x7];                                     // 0x0051(0x0007) MISSED OFFSET (PADDING)
...
struct FPromptEvaluation
{
	...
	unsigned char                                      UnknownData_V1P7[0x7];                                     // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FPermanentPromptNetworkEvent : public FNetworkEventStruct
{
	...
	unsigned char                                      UnknownData_B6UC[0x7];                                     // 0x0079(0x0007) MISSED OFFSET (PADDING)
