...
struct FRowboatDamageEffectData
{
	...
	unsigned char                                      UnknownData_BJJ1[0xC];                                     // 0x000C(0x000C) MISSED OFFSET (PADDING)
...
struct FScrapeableDamageSpeedEntry
{
	...
	unsigned char                                      UnknownData_DCYX[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (PADDING)
...
struct FWatercraftRolloverCorrector
{
	...
	unsigned char                                      UnknownData_26WF[0x4];                                     // 0x0008(0x0004) MISSED OFFSET (PADDING)
...
struct FOar
{
	...
	unsigned char                                      UnknownData_UHYV[0x28];                                    // 0x0038(0x0028) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_5E5W[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_Q0HE[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_AHCA[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
struct FRowboatMountStateTelemetryEvent
{
	...
	unsigned char                                      UnknownData_HLE0[0x3];                                     // 0x0011(0x0003) MISSED OFFSET (PADDING)
...
struct FWatercraftDespawnTelemetryEvent
{
	...
	unsigned char                                      UnknownData_NBXZ[0x3];                                     // 0x001D(0x0003) MISSED OFFSET (PADDING)
