...
public:
	...
	{
		static auto ptr = UObject::FindClass("Class AthenaStatusResponse.StatusResponseApplyOneShotStatus");
		return ptr;
	}
...
public:
	...
	unsigned char                                      UnknownData_MNZ0[0x4];                                     // 0x004C(0x0004) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("Class AthenaStatusResponse.StatusResponseApplyPersistentStatus");
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("Class AthenaStatusResponse.StatusResponseCancelStatus");
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("Class AthenaStatusResponse.StatusResponseCook");
		return ptr;
	}
...
public:
	...
	unsigned char                                      UnknownData_NPIU[0x4];                                     // 0x0034(0x0004) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("Class AthenaStatusResponse.StatusResponseHealthRegenerationPoolChange");
		return ptr;
	}
...
public:
	...
	unsigned char                                      UnknownData_GDKW[0x3];                                     // 0x0049(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_ASZS[0x20];                                    // 0x0050(0x0020) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("Class AthenaStatusResponse.StatusResponseReportNoiseEvent");
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("Class AthenaStatusResponse.StatusResponseSetScalarParamOnCharacter");
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("Class AthenaStatusResponse.StatusResponseSuspendStatus");
		return ptr;
	}
