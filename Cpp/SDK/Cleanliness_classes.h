...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("Class Cleanliness.CleanlinessTransferInterface");
		return ptr;
	}
...
{
public:
	unsigned char                                      UnknownData_3JDQ[0x10];                                    // 0x00C8(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_MMXP[0x54];                                    // 0x00F4(0x0054) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("Class Cleanliness.CleanlinessComponent");
		return ptr;
	}
