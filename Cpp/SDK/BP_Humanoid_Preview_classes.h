...
public:
	...
	unsigned char                                      UnknownData_WBNY[0x8];                                     // 0x0AA8(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
		static auto ptr = UObject::FindClass("AnimBlueprintGeneratedClass BP_Humanoid_Preview.BP_Humanoid_Preview_C");
		return ptr;
	}
