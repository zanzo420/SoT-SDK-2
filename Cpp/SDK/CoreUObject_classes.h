...
{
public:
	unsigned char                                      UnknownData_CK7O[0x40];                                    // 0x0030(0x0040) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_DRL9[0x8];                                     // 0x0070(0x0008) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_SDY1[0x8];                                     // 0x0070(0x0008) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_MEJT[0x38];                                    // 0x0070(0x0038) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_20R1[0x8];                                     // 0x0070(0x0008) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_4CI8[0x8];                                     // 0x0070(0x0008) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_5TNM[0x38];                                    // 0x0028(0x0038) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_YXLI[0x28];                                    // 0x0028(0x0028) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      pad_LZK29VILUY[0x40];                                      // 0x0048(0x0040) NOT AUTO-GENERATED PROPERTY
...
{
public:
	unsigned char                                      UnknownData_X5GQ[0x10];                                    // 0x0088(0x0010) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_DC8M[0x58];                                    // 0x0028(0x0058) MISSED OFFSET (PADDING)
...
public:
	...
	uint16_t                                           RepOffset;                                                 // 0x008C(0x0002) NOT AUTO-GENERATED PROPERTY
	uint16_t                                           NumParms;                                                  // 0x008E(0x0002) NOT AUTO-GENERATED PROPERTY
	uint16_t                                           ParmsSize;                                                 // 0x0090(0x0002) NOT AUTO-GENERATED PROPERTY
	uint16_t                                           ReturnValueOffset;                                         // 0x0092(0x0002) NOT AUTO-GENERATED PROPERTY
	uint16_t                                           RPCId;                                                     // 0x0094(0x0002) NOT AUTO-GENERATED PROPERTY
	uint16_t                                           RPCResponseId;                                             // 0x0096(0x0002) NOT AUTO-GENERATED PROPERTY
	...
	unsigned char                                      pad_UDS3CDSSHH[0x04];                                      // 0x00AC(0x0004) NOT AUTO-GENERATED PROPERTY
	void*                                              Func;                                                      // 0x00B0(0x0008) NOT AUTO-GENERATED PROPERTY
	unsigned char                                      pad_J5SI5Y33X3[0x8];                                       // 0x00B8(0x0008) NOT AUTO-GENERATED PROPERTY
...
{
public:
	unsigned char                                      UnknownData_Y6UA[0x10];                                    // 0x00B8(0x0010) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_3CSP[0x28];                                    // 0x0028(0x0028) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_8QDE[0x28];                                    // 0x0030(0x0028) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_5MW7[0x138];                                   // 0x0088(0x0138) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_ET5M[0x150];                                   // 0x01C0(0x0150) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_ST54[0x60];                                    // 0x0028(0x0060) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_IX6L[0x150];                                   // 0x00B8(0x0150) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_VDOI[0x50];                                    // 0x0028(0x0050) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_6C97[0x8];                                     // 0x0028(0x0008) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_KWUY[0x8];                                     // 0x0070(0x0008) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_PGVG[0x8];                                     // 0x0078(0x0008) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_YXNP[0x8];                                     // 0x0070(0x0008) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_YDAA[0x8];                                     // 0x0070(0x0008) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_AIPZ[0x8];                                     // 0x0078(0x0008) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_XJS6[0x8];                                     // 0x0070(0x0008) MISSED OFFSET (PADDING)
