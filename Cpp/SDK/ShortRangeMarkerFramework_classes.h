...
public:
	...
	unsigned char                                      UnknownData_7Q1V[0x4];                                     // 0x0034(0x0004) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_1B0S[0x10];                                    // 0x0428(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
