...
{
public:
	unsigned char                                      UnknownData_MKOZ[0x8];                                     // 0x00C8(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	class USeasonProgressionUIInputBinder*             InputBinder;                                               // 0x00D0(0x0008) (ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class USeasonProgressionUICompositeInputHandler*   InputHandler;                                              // 0x00D8(0x0008) (ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	TArray<struct FEnableMoreButtonEvent>              DetailsNavigationDesc;                                     // 0x00E0(0x0010) (ZeroConstructor)
	unsigned char                                      UnknownData_1HEX[0xB8];                                    // 0x00F0(0x00B8) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_GJHY[0x20];                                    // 0x00D8(0x0020) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_5QRX[0x30];                                    // 0x0428(0x0030) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	class USeasonPopupListAsset*                       SeasonPopupListAsset;                                      // 0x0458(0x0008) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	unsigned char                                      UnknownData_X81H[0x118];                                   // 0x0460(0x0118) MISSED OFFSET (PADDING)
