...
{
public:
	unsigned char                                      UnknownData_5HI5[0x18];                                    // 0x0028(0x0018) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_UWPP[0x30];                                    // 0x0028(0x0030) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
public:
	unsigned char                                      UnknownData_ITOG[0x28];                                    // 0x0028(0x0028) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_VT0P[0x10];                                    // 0x0428(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_I0JD[0x10];                                    // 0x0440(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_8BF0[0xE0];                                    // 0x0458(0x00E0) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
public:
	unsigned char                                      UnknownData_467H[0x10];                                    // 0x0548(0x0010) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_YL2Q[0x8];                                     // 0x0288(0x0008) Fix Super Size
	...
	unsigned char                                      UnknownData_HIPS[0x10];                                    // 0x0310(0x0010) MISSED OFFSET (PADDING)
