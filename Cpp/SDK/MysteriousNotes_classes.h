...
public:
	...
	struct FText                                       NotificationText;                                          // 0x0080(0x0018) ELEMENT_SIZE_MISMATCH (Edit, Config, DisableEditOnInstance)
	unsigned char                                      UnknownData_1XFN[0x20];                                    // 0x0080(0x0020) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
public:
	...
	unsigned char                                      UnknownData_FS5B[0x20];                                    // 0x0028(0x0020) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FText                                       DefaultBody;                                               // 0x0060(0x0018) ELEMENT_SIZE_MISMATCH (Edit, DisableEditOnInstance)
	unsigned char                                      UnknownData_MG2A[0x20];                                    // 0x0060(0x0020) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
{
public:
	unsigned char                                      UnknownData_DO6H[0x28];                                    // 0x0428(0x0028) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_BLAV[0x88];                                    // 0x0468(0x0088) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_8BTZ[0x8];                                     // 0x00C8(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_RE0N[0x14E];                                   // 0x00EA(0x014E) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_V6F3[0x10];                                    // 0x07D0(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_587D[0x54];                                    // 0x07FC(0x0054) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_AN3V[0x118];                                   // 0x0868(0x0118) MISSED OFFSET (PADDING)
