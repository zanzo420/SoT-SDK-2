...
struct FReviveEffectsValues
{
	...
	unsigned char                                      UnknownData_TWZX[0x18];                                    // 0x0008(0x0018) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_YDBY[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_JYEK[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
struct FReviveableActionStateConstructionInfo : public FActorActionStateConstructionInfo
{
	...
	unsigned char                                      UnknownData_EG70[0x6];                                     // 0x0062(0x0006) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_74LP[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_OMNC[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_03G0[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_3LJD[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_4U4W[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_YTUT[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_V34V[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_3GT7[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_IZNM[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_K2R9[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_RPG9[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
struct FRevivingWindowStart
{
	...
	unsigned char                                      UnknownData_ARY5[0x7];                                     // 0x0029(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FModeSpecificReviveSettings
{
	...
	unsigned char                                      UnknownData_13DA[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
