...
{
	unsigned char                                      UnknownData_EZZL[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
struct FEventRepairableObjectRepairEndedEvent
{
	...
	unsigned char                                      UnknownData_118T[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_ZEEI[0x4];                                     // 0x0024(0x0004) MISSED OFFSET (PADDING)
