...
struct FTrackItemOwnershipEvent
{
	...
	class AActor*                                      ItemRepresentation;                                        // 0x0008(0x0008) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
struct FCrewTrackedItemOwnershipChanged
{
	...
	unsigned char                                      UnknownData_1ZJU[0x7];                                     // 0x0029(0x0007) MISSED OFFSET (PADDING)
