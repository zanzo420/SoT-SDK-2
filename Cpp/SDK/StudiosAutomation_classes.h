...
{
public:
	unsigned char                                      UnknownData_SEPE[0x8];                                     // 0x0430(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_DA62[0x2];                                     // 0x043E(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_ON5L[0x2];                                     // 0x0452(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_D0ZN[0x4];                                     // 0x045C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_V15T[0x3C];                                    // 0x04B4(0x003C) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_HFF8[0x38];                                    // 0x0028(0x0038) MISSED OFFSET (PADDING)
...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("Class StudiosAutomation.DummyReplicatedActor");
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("Class StudiosAutomation.ObjectWithSettableWorld");
		return ptr;
	}
