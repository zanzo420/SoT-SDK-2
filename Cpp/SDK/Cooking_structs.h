...
struct FCookableComponentSmokeFeedbackTimingEntry
{
	...
	unsigned char                                      UnknownData_NIAR[0x3];                                     // 0x0005(0x0003) MISSED OFFSET (PADDING)
...
struct FCookingInfo
{
	unsigned char                                      UnknownData_IMFN[0xC];                                     // 0x0000(0x000C) MISSED OFFSET (PADDING)
...
struct FCookingClientRepresentation
{
	...
	unsigned char                                      UnknownData_9H9A[0x6];                                     // 0x0002(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_CXQ4[0x20];                                    // 0x0010(0x0020) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	...
	unsigned char                                      UnknownData_YL26[0x3];                                     // 0x0051(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_KYRF[0x4];                                     // 0x0064(0x0004) MISSED OFFSET (PADDING)
...
struct FCookerSmokeFeedbackEntry
{
	...
	unsigned char                                      UnknownData_DVF4[0x7];                                     // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_V9GN[0x10];                                    // 0x0000(0x0010) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_LG63[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
struct FCookEndTelemetryEvent
{
	...
	unsigned char                                      UnknownData_42VW[0x3];                                     // 0x0011(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FCookStartTelemetryEvent
{
	struct FString                                     ItemName;                                                  // 0x0000(0x0010) (ZeroConstructor, HasGetValueTypeHash)
	TEnumAsByte<Cooking_ECookingState>                 CookState;                                                 // 0x0010(0x0001) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	unsigned char                                      UnknownData_HDCC[0x3];                                     // 0x0011(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FVector                                     Location;                                                  // 0x0014(0x000C) (ZeroConstructor, IsPlainOldData, NoDestructor)
	struct FGuid                                       CookId;                                                    // 0x0020(0x0010) (ZeroConstructor, IsPlainOldData, NoDestructor)
