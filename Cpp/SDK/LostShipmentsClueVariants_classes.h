...
{
public:
	unsigned char                                      UnknownData_YHVY[0x4];                                     // 0x042C(0x0004) Fix Super Size
	unsigned char                                      UnknownData_UX5Y[0x10];                                    // 0x0430(0x0010) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_ZPCR[0x4];                                     // 0x0044(0x0004) MISSED OFFSET (PADDING)
...
{
public:
	struct FNPCData                                    NPCData;                                                   // 0x0030(0x00B8)
	unsigned char                                      UnknownData_Z2F9[0x30];                                    // 0x00E8(0x0030) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_U5CE[0x8];                                     // 0x0138(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
public:
	unsigned char                                      UnknownData_ZQPM[0x70];                                    // 0x0150(0x0070) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_F8NJ[0x4];                                     // 0x007C(0x0004) MISSED OFFSET (PADDING)
...
// 0x02B0 (FullSize[0x02F0] - InheritedSize[0x0040])
class UTaleQuestClueInventoryService : public UTaleQuestService
{
public:
	unsigned char                                      UnknownData_A31N[0x48];                                    // 0x0040(0x0048) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	TArray<class UClueDescriptor*>                     ObtainedClues;                                             // 0x0088(0x0010) (ZeroConstructor, Transient)
	unsigned char                                      UnknownData_NQAL[0x50];                                    // 0x0098(0x0050) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	TMap<class UClueDescriptor*, class AActor*>        DiscovererMap;                                             // 0x00E8(0x0050) (ZeroConstructor, Transient)
	unsigned char                                      UnknownData_9EUR[0x180];                                   // 0x0138(0x0180) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FText                                       TitleText;                                                 // 0x02B8(0x0018) ELEMENT_SIZE_MISMATCH (Transient)
	unsigned char                                      UnknownData_6XUY[0x20];                                    // 0x0138(0x0020) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
public:
	...
	unsigned char                                      UnknownData_U09J[0x4];                                     // 0x0028(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	TAssetPtr<class UClass>                            CircleMapItem;                                             // 0x0048(0x001C) ELEMENT_SIZE_MISMATCH (Edit, UObjectWrapper, HasGetValueTypeHash)
	unsigned char                                      UnknownData_AZLW[0x4];                                     // 0x0048(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
public:
	...
	unsigned char                                      UnknownData_WIVL[0x18];                                    // 0x0070(0x0018) MISSED OFFSET (PADDING)
...
public:
	...
	struct FQuestVariableActor                         Discoverer;                                                // 0x0040(0x0010) (Edit)
...
public:
	...
	unsigned char                                      UnknownData_F2CQ[0x4];                                     // 0x0030(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	...
	unsigned char                                      UnknownData_O6KT[0x4];                                     // 0x005C(0x0004) MISSED OFFSET (PADDING)
...
{
public:
	class UClass*                                      BottleItemType;                                            // 0x0030(0x0008) (ZeroConstructor, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash)
	struct FName                                       IslandNameToSpawnOn;                                       // 0x0038(0x0008) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FGuid                                       IslandSpawnLocationReservationId;                          // 0x0040(0x0010) (ZeroConstructor, IsPlainOldData, NoDestructor)
	struct FTransform                                  SpawnTransform;                                            // 0x0050(0x0030) (IsPlainOldData, NoDestructor)
	unsigned char                                      UnknownData_9C04[0x30];                                    // 0x0080(0x0030) MISSED OFFSET (PADDING)
...
{
public:
	class UClass*                                      SkeletonPoseType;                                          // 0x0030(0x0008) (ZeroConstructor, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash)
	class UClass*                                      ClueItemType;                                              // 0x0038(0x0008) (ZeroConstructor, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash)
	...
	unsigned char                                      UnknownData_YRA3[0x8];                                     // 0x0058(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FTransform                                  SpawnTransform;                                            // 0x0060(0x0030) (IsPlainOldData, NoDestructor)
	unsigned char                                      UnknownData_V4M5[0x30];                                    // 0x0090(0x0030) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_583M[0x4];                                     // 0x0040(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	...
	unsigned char                                      UnknownData_Q0PW[0x4];                                     // 0x006C(0x0004) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_DY1I[0x18];                                    // 0x00C8(0x0018) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FClueDestinationChoice                      CurrentClueDestination;                                    // 0x00E0(0x0010) (Net, Transient, RepNotify)
	class UAbandonedNoteClueTextIndexAssetMap*         ClueTextIndexAssetMap;                                     // 0x00F0(0x0008) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FString                                     CompositeFormatString;                                     // 0x00F8(0x0010) (Edit, ZeroConstructor, DisableEditOnInstance, HasGetValueTypeHash)
	struct FText                                       CurrentTitleText;                                          // 0x0108(0x0018) ELEMENT_SIZE_MISMATCH (Net, RepNotify)
	unsigned char                                      UnknownData_PENA[0x20];                                    // 0x0108(0x0020) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      UnknownData_N5MQ[0xB0];                                    // 0x0140(0x00B0) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_VUWN[0x40];                                    // 0x0148(0x0040) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_UT6W[0x10];                                    // 0x07D0(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_90M5[0xF];                                     // 0x0801(0x000F) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_UCVF[0x2C];                                    // 0x003C(0x002C) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_V99M[0x10];                                    // 0x00C8(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_EQ4Y[0x7];                                     // 0x00F1(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_YQKX[0x7];                                     // 0x0101(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	TArray<struct FMapTextureRenderData>               ClueRenderData;                                            // 0x0108(0x0010) (ZeroConstructor)
	unsigned char                                      UnknownData_0B72[0x48];                                    // 0x0118(0x0048) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_O7OC[0x4];                                     // 0x0880(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FMapRadialIconData                          MapRadialIconData;                                         // 0x08A0(0x0018) (Net, RepNotify)
	unsigned char                                      UnknownData_F4IA[0x8];                                     // 0x08B8(0x0008) MISSED OFFSET (PADDING)
...
public:
	struct FVector                                     SpawnLocation;                                             // 0x0030(0x000C) (ZeroConstructor, IsPlainOldData, NoDestructor)
	unsigned char                                      UnknownData_MJI8[0x2C];                                    // 0x003C(0x002C) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_3FCU[0x8];                                     // 0x00C8(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_7EY0[0x7];                                     // 0x00D1(0x0007) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_IRNU[0x7];                                     // 0x0071(0x0007) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_4BF0[0x4];                                     // 0x0084(0x0004) MISSED OFFSET (PADDING)
