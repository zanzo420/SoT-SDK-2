...
{
public:
	unsigned char                                      UnknownData_8O7S[0x18];                                    // 0x0028(0x0018) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_EFOQ[0x10];                                    // 0x0028(0x0010) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_NI95[0x10];                                    // 0x0028(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_QO21[0x124];                                   // 0x005C(0x0124) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_Z5PV[0x58];                                    // 0x0428(0x0058) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	class UWwiseObjectPoolWrapper*                     PoolWrapper;                                               // 0x0480(0x0008) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	unsigned char                                      UnknownData_T6BM[0x8];                                     // 0x0488(0x0008) MISSED OFFSET (PADDING)
