...
{
	static auto fn = UObject::FindObject<UFunction>("Function AthenaAI.AthenaFaunaAIController.SetDormancyCheckingEnabled");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function AthenaAI.AICombatEncounterInterface.OnVulnerabilityStateEntered");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function AthenaAI.AIManagerBlueprintFunctionLibrary.GetFrameCounter");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function AthenaAI.AIManagerBlueprintFunctionLibrary.AddNameplateToAIWithLocalisedName");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function AthenaAI.DebugAIManagerServiceInterface.BlockAIAbility");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function AthenaAI.DebugAIManagerService.BlockAIAbility");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function AthenaAI.AINameplateComponent.OnRep_Title");
...
// Function AthenaAI.AINameplateComponent.OnRep_DisplayNameAsText
// (Final, Native, Private)
void UAINameplateComponent::OnRep_DisplayNameAsText()
{
	static auto fn = UObject::FindObject<UFunction>("Function AthenaAI.AINameplateComponent.OnRep_DisplayNameAsText");

	UAINameplateComponent_OnRep_DisplayNameAsText_Params params;
...
{
	static auto fn = UObject::FindObject<UFunction>("Function AthenaAI.AINameplateComponent.OnRep_DisplayNameAsString");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function AthenaAI.AINameplateComponent.OnRep_DebugDisplayText");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function AthenaAI.AIPartsRetrievalComponent.RequestNewAIParts");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function AthenaAI.AIPartsRetrievalComponent.OnRep_ReplicatedAIPartsData");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function AthenaAI.BurrowCrack.OnRep_StartFadeAndLifeSpan");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function AthenaAI.BurrowCrack.OnLifeSpanPercentLeft");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function AthenaAI.AthenaAIDebugFunctionLibrary.KillAllDebugAISpawners");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function AthenaAI.AthenaAIDebugFunctionLibrary.CreateAISpawnerAtPosition");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function AthenaAI.AthenaAIDebugFunctionLibrary.CreateAISpawnerAtActor");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function AthenaAI.AthenaSwimmingAIController.ApplyControllerParams");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function AthenaAI.TinySharkExperience.OnRep_TinySharkPawn");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function AthenaAI.Pet.SetExitTakeOffFlag");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function AthenaAI.Pet.OnShipDestroyed");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function AthenaAI.Pet.OnRep_RollRequest");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function AthenaAI.Pet.OnRep_ResetRollAndZOffset");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function AthenaAI.Pet.OnRep_PetTurnToFaceData");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function AthenaAI.Pet.OnRep_PetOwner");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function AthenaAI.Pet.OnRep_PetIsSad");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function AthenaAI.Pet.OnRep_PerchedInHangout");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function AthenaAI.Pet.OnRep_MovementRequest");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function AthenaAI.Pet.OnRep_InHangout");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function AthenaAI.Pet.OnOwnerDestroyed");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function AthenaAI.Pet.Multicast_DitherOut");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function AthenaAI.Pet.Multicast_DitherIn");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function AthenaAI.Pet.GetFloorMeshOffsetZ");
